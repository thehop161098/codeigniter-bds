		...
		<div class="contents">
			<div class="row">
				<?php foreach ($newsLandSame as $key_newsLandSame => $val_newsLandSame) { ?>
					<div class="col-md-4">
						<div class="item">
							<a href="<?=$val_newsLandSame['alias']; ?>" title="<?=$val_newsLandSame['name']; ?>">
								<div class="boxImg lazy" data-src="upload/newsLand/thumb/<?=$val_newsLandSame['thumb']; ?>">
									...
									<div class="distrist"><i class="fas fa-map-marker-alt"></i><?=$val_newsLandSame['infoDistrict']['name']; ?></div>
								</div>
							</a>
							<div class="info">
					...
					<?php if(($key_newsLandSame + 1) % 3 == 0) { ?><div class="clear hidden-sm hidden-xs"></div><?php } ?>
					<?php if(($key_newsLandSame + 1) % 2 == 0) { ?><div class="clear hidden-lg hidden-md hidden-xs"></div><?php } ?>
				<?php } ?>
			</div>
		</div>
	</div>
