<div class="sidebar">
	<div class="row">
		...
		<div class="col-md-12 col-sm-6 col-xs-12">
			<?php if(isset($wardSame) && ! empty($wardSame)) { ?>
				<div class="catePro">
					<div class="title"><span>Phường/Xã</span></div>
					<div class="contents">
						<ul>
							<?php foreach ($wardSame as $key_wardSame => $val_wardSame) { ?>
								<li><a href="<?=$val_wardSame['alias']; ?>"><i class="fas fa-chevron-right"></i><?=$val_wardSame['name']; ?></a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
