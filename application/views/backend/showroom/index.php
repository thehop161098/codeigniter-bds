            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url()?>otadmin/mapShowroom/index/<?=$val['id'];?>" class="btn btn-sm btn-info waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Xem map"> <i class="fa fa-eye"></i> </a>
                            ...
                            <?php if(isset($val['mapShowroom']) && empty($val['mapShowroom'])):?>
