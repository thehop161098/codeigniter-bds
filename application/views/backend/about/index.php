        ...
        <div class="white-box">
            ...
            <form data-toggle="validator" novalidate="true" method="post" action="" enctype="multipart/form-data">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label for="inputName" class="control-label">Youtube (Ví dụ: https://www.youtube.com/watch?v=<b class="text-danger">jkoyslzcjm0</b>)</label>
                ...
                <div class="form-group">
                    <label>Mô tả</label>
                    <textarea class="form-control ckeditor" name="des" rows="5"><?php if(isset($datas['des']) && $datas['des']!=''){ echo $datas['des']; }?></textarea>
                </div>
