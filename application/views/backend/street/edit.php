            ...
            <form data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="inputName" class="control-label">Đường</label>
                        <input required requiredmsg="Vui lòng nhập đường" type="text" class="form-control" id="name" name="name" value="<?php if(isset($datas['name']) && $datas['name']!=''){ echo $datas['name']; }?>" onkeyup="createSlug(this);" data-control="<?php echo $control;?>">
                    </div>
                    <div class="form-group">
