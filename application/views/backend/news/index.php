                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $val) { ?>
                            <tr>
                                ...
                                <td width="200"><a href="<?=$val['alias'];?>" target="_blank"><?php echo $val['name'];?></a></td>
                                <td class="text-center"><?php echo $val['cate_name'];?></td>
                                ...
                                <td class="text-center">
                                    <div class="checkbox checkbox-success">
                                        <input onclick="checkShowGlobals(<?php echo $val['id'];?>,'home');" <?php if($val['home'] == 1){ ?> checked="" <?php } ?> id="home<?php echo $val['id'];?>" type="checkbox" name="home" class="home<?php echo $val['id'];?>" value="1" data-control="<?php echo $control;?>">
                                        <label for="home<?php echo $val['id'];?>">Home</label>
                                    </div>
                                </td>
                                <td class="text-center">
