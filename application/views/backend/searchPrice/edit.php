            ...
            <div class="white-box">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" onkeyup="return FormatNumber(this)" class="form-control" required="" value="<?php if(isset($datas['price']) && $datas['price']!=''){ echo number_format($datas['price']); }?>" name="price" id="price"></input>
                        </div>
                    </div>
