            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center no-sort">Duyệt</th>
                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $val) { ?>
                            <tr>
                                ...
                                <td><?=$val['fullname'] ?></td>
                                <td width="160"><a href="<?php echo $val['alias'];?>" target="_blank"><?php echo $val['name'];?></a>
                                    <div class="clear"></div>
                                    <?php if($val['code'] != ''){ ?><span class="text-danger"><i class="fa fa-qrcode"></i> Mã: <?php echo $val['code'];?></span> <?php } ?>
                                </td>
                                <td class="text-left"><?=$val['cate_name'] ?></td>
                                ...
                                <td class="text-center">
                                    <div class="checkbox checkbox-success box-check-left">
                                        <input onclick="checkShowGlobals(<?php echo $val['id'];?>,'hot');" <?php if($val['hot'] == 1){ ?> checked="" <?php } ?> id="hot<?php echo $val['id'];?>" type="checkbox" name="hot" class="hot<?php echo $val['id'];?>" value="1" data-control="<?php echo $control;?>">
                                        <label for="hot<?php echo $val['id'];?>">Hot</label>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <a href="<?php echo $path_url;?>edit/<?php echo $val['id'];?>" class="btn btn-sm btn-info waves-effect waves-light"> <i class="fa fa-edit"></i> </a>
