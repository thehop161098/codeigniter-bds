        ...
        <div class="white-box">
            ...
            <form data-toggle="validator" novalidate="true" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="to" id="to" value="<?php if(isset($datas['to']) && $datas['to']!=''){ echo $datas['to']; }?>">
                </div>
                <div class="form-group">
                    <label for="inputName" class="control-label">Giá đến</label>
                    <input type="text" class="form-control" name="from" id="from" value="<?php if(isset($datas['from']) && $datas['from']!=''){ echo $datas['from']; }?>">
                </div>
