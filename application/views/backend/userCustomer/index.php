            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center no-sort">Danh sách đã đăng</th>
                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $val) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a data-toggle="modal" data-target="#myListNewsLand<?php echo $val['id'];?>" class="btn btn-sm btn-info waves-effect waves-light"> <i class="fa fa-eye"></i> </a>
                                </td>
                                <td class="text-center">
...
<?php $this->load->view('backend/userCustomer/listNewsLand'); ?>
<!-- datatables JS -->
