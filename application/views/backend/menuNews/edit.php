            ...
            <div class="white-box">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" onkeyup="createSlug(this);" class="form-control" id="name" name="name" data-control="<?php echo $control;?>" value="<?php if(isset($datas['name']) && $datas['name']!=''){ echo $datas['name']; }?>">
                    </div>
                    <div class="form-group">
