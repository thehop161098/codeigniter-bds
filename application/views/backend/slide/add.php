        ...
        <div class="white-box">
            ...
            <form data-toggle="validator"  method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="link" name="link" value="<?php if($ViewData){echo $ViewData['link'];}?>">
                </div>
                <div>
                    <label for="input-file-now">Hình ảnh (width: 1700 x height: auto)</label>
