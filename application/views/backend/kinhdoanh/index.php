            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Usernam</th>
                        <th class="text-center">Ngày tạo</th>
                        <th class="text-center no-sort">Active</th>
                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $val) { ?>
                            <tr>
                                ...
                                <td><a href="<?php echo $path_url;?>edit/<?php echo $val['id'];?>"><?php echo $val['fullname'];?></a></td>
                                <td class="text-center"><?php echo $val['username'];?></td>
                                <td class="text-center"><?php echo date('d/m/Y',strtotime($val['created_at']));?></td>
                                <td class="text-center">
                                    <div class="checkbox checkbox-success">
                                        <input onclick="checkActive(<?php echo $val['id'];?>);" <?php if($val['active'] == 1){ ?> checked="" <?php } ?> id="active<?php echo $val['id'];?>" type="checkbox" name="active" class="active<?php echo $val['id'];?>" value="1" data-control="<?php echo $control;?>">
                                        <label for="active<?php echo $val['id'];?>"></label>
                                    </div>
                                </td>
                                <td class="text-center">
