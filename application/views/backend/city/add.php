            ...
            <form data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input onkeyup="createSlug(this);" required requiredmsg="Vui lòng nhập Tỉnh thành" type="text" class="form-control" id="name" name="name" data-control="<?php echo $control;?>">
                    </div>
                    <div class="form-group">
