...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <a href="<?=base_url();?>otadmin/district/index/<?=$idDistrict['city_id'];?>" class="btn btn-info waves-effect waves-light"><i class="fa fa-arrow-left"></i></a>
            <a href="<?php echo $path_url;?>index/<?=$id;?>" class="btn btn-info waves-effect waves-light"><i class="icon-refresh"></i></a>
                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $val) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url()?>otadmin/street/index/<?=$val['id'];?>" class="btn btn-sm btn-info waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Xem đường"> <i class="fa fa-eye"></i> </a>
                                    ...
                                    <?php if(isset($val['street']) && empty($val['street'])):?>
