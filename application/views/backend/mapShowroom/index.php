...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <a href="<?php echo $path_url;?>add/<?=$id;?>" class="btn btn-success waves-effect waves-light"><i class="icon-plus"></i>Thêm mới</a>
            ...
            <a href="<?=base_url();?>otadmin/showroom/index/<?=$idDistrict['city_id'];?>" class="btn btn-info waves-effect waves-light"><i class="fa fa-arrow-left"></i></a>
                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $val) { ?>
                            <tr>
                                ...
                                <td width="300"><a href="<?php echo $path_url;?>edit/<?php echo $val['id'];?>"><?php echo $val['name'];?></a></td>
                                <td class="text-center"><input onkeyup="changeSort(this,<?php echo $val['id'];?>);" type="text" class="form-control text-center" value="<?php echo $val['sort'];?>" data-control="<?php echo $control;?>"></td>
                                <td class="text-center">
                                    <div class="checkbox checkbox-success">
                                        <input onclick="checkShowGlobals(<?php echo $val['id'];?>,'publish');" <?php if($val['publish'] == 1){ ?> checked="" <?php } ?> id="publish<?php echo $val['id'];?>" type="checkbox" name="publish" class="publish<?php echo $val['id'];?>" value="1" data-control="<?php echo $control;?>">
                                        <label for="publish<?php echo $val['id'];?>"></label>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <a href="<?php echo $path_url;?>edit/<?php echo $val['id'];?>" class="btn btn-sm btn-info waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Cập nhật"> <i class="fa fa-edit"></i> </a>
                                    <a onclick="del(<?php echo $val['id'];?>);" class="btn btn-sm btn-youtube waves-effect waves-light delete<?php echo $val['id'];?>" data-control="<?php echo $control;?>" data-toggle="tooltip" data-placement="top" title="Xóa"> <i class="ti-trash"></i> </a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
