                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $val) { ?>
                            <tr>
                                ...
                                <td class="text-center"><input onkeyup="changeSort2(this,<?php echo $val['id'];?>);" type="text" class="form-control text-center sort<?php echo $val['id'];?>" value="<?php echo $val['sort'];?>" data-control="<?php echo $control;?>"></td>
                                <td class="text-center">
