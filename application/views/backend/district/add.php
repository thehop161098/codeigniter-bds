            ...
            <form data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input required requiredmsg="Vui lòng nhập quận/huyện" type="text" class="form-control" id="name" name="name" onkeyup="createSlug(this);" data-control="<?php echo $control;?>">
                    </div>
                    <div class="form-group">
