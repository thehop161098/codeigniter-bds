...
<div class="row">
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <a href="<?=base_url();?>otadmin/city/index" class="btn btn-info waves-effect waves-light"><i class="fa fa-arrow-left"></i></a>
                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $val) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url()?>otadmin/ward/index/<?=$val['id'];?>" class="btn btn-sm btn-info waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Xem phường xã"> <i class="fa fa-eye"></i> </a>
                                    ...
                                    <?php if(isset($val['ward']) && empty($val['ward'])):?>
