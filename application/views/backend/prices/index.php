            ...
            <table id="myTable" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Giá đến</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo $val['to'];?></td>
                        <td class="text-center"><?php echo $val['from'];?></td>
                        <td class="text-center"><?php echo date('d/m/Y',strtotime($val['created_at']));?></td>
                        <td class="text-center">
                            <div class="checkbox checkbox-success">
                                <input onclick="checkShow(<?php echo $val['id'];?>);" <?php if($val['publish'] == 1){ ?> checked="" <?php } ?> id="publish<?php echo $val['id'];?>" type="checkbox" name="publish" class="publish<?php echo $val['id'];?>" value="1" data-control="<?php echo $control;?>">
