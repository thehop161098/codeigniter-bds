...
class Slogan extends Admin_Controller {
	//Config Module
	var $title = 'Slogan';
	var $path_dir = 'upload/slogan/';
	var	$path_dir_thumb = 'upload/slogan/thumb/';
	var	$path_url = 'otadmin/slogan/';
	var	$table = 'tbl_photo';
	var	$template = 'backend/slogan/';
	var	$control = 'slogan';
