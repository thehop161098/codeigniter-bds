...
class Menu extends Admin_Controller {
	//Config Module
	var $title = 'Menu';
	var $path_dir = 'upload/menu/';
	var	$path_dir_thumb = 'upload/menu/thumb/';
	var	$path_url = 'otadmin/menu/';
	var	$table = 'tbl_menu';
	var	$template = 'backend/menu/';
	var	$control = 'menu';
	...
	public function index()
	{
		...
		if($_GET['parentid']){
			$data['datas'] = $this->CI_function->showMenuTable($_GET['parentid']);
		}else{
			$data['datas'] = $this->CI_function->showMenuTable(0);
		}
		if($data['datas'] != NULL){
		...
		$data['menus'] = $this->CI_function->getSelectMenu(0);
	...
	public function edit($id=0)
	{
		...
		$data['menus'] = $this->CI_function->getSelectMenu(0,'',$data['datas']['parentid']);
		$data['select_cate'] = $this->CI_function->getSelectCategory(0,'',$data['datas']['categoryid'],$data['datas']['type']);
		if($this->input->post()){
			///////
