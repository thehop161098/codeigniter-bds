...
class MenuNewsLand extends Admin_Controller {
	//Config Module
	var $title = 'Menu tin bds';
	var $path_dir = 'upload/menuNewsLand/';
	var	$path_dir_thumb = 'upload/menuNewsLand/thumb/';
	var	$path_url = 'otadmin/menuNewsLand/';
	var	$table = 'tbl_category';
	var	$template = 'backend/menuNewsLand/';
	var	$control = 'menuNewsLand';
	...
	public function index()
	{
		...
		if($_GET['parentid']){
			$data['datas'] = $this->CI_function->showMenuNewsLand($_GET['parentid']);
		}else{
			$data['datas'] = $this->CI_function->showMenuNewsLand(0);
		}
		if($data['datas'] != NULL){
		...
		$data['menus'] = $this->CI_function->getSelectCategory(0,'',$_GET['parentid'],2);
	...
	public function add()
	{
		...
		$data['menus'] = $this->CI_function->getSelectCategory(0,'','',2);
		$this->load->view('backend/default/index', isset($data)?$data:NULL);
	}
	public function edit($id=0)
	{
		...
		$data['menus'] = $this->CI_function->getSelectCategory(0,'',$data['datas']['parentid'],2);
		if($this->input->post()){
			///////
