...
class MenuProject extends Admin_Controller {
	//Config Module
	var $title = 'Lĩnh vực';
	var $path_dir = 'upload/menuProject/';
	var	$path_dir_thumb = 'upload/menuProject/thumb/';
	var	$path_url = 'otadmin/menuProject/';
	var	$table = 'tbl_category';
	var	$template = 'backend/menuProject/';
	var	$control = 'menuProject';
	...
	public function index()
	{
		...
		if($_GET['parentid']){
			$data['datas'] = $this->CI_function->showMenuProject($_GET['parentid']);
		}else{
			$data['datas'] = $this->CI_function->showMenuProject(0);
		}
		if($data['datas'] != NULL){
		...
		$data['menus'] = $this->CI_function->getSelectCategory(0,'',$_GET['parentid'],8);
	...
	public function add()
	{
		...
		$data['menus'] = $this->CI_function->getSelectCategory(0,'','',8);
		$this->load->view('backend/default/index', isset($data)?$data:NULL);
	}
	public function edit($id=0)
	{
		...
		$data['menus'] = $this->CI_function->getSelectCategory(0,'',$data['datas']['parentid'],8);
		if($this->input->post()){
			///////
