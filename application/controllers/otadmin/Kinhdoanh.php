...
class Kinhdoanh extends Admin_Controller {
	//Config Module
	var $title = 'Kinh doanh';
	var	$path_url = 'otadmin/kinhdoanh/';
	var	$table = 'tbl_admin';
	var	$template = 'backend/kinhdoanh/';
	var	$control = 'kinhdoanh';
	...
	public function index()
	{
		...
		$data['datas'] = $this->query_sql->select_array($this->table,'*',array('role_id' => 2),'id desc');
