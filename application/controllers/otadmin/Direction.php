...
class Direction extends Admin_Controller {
	//Config Module
	var $title = 'Hướng';
	var $path_dir = 'upload/direction/';
	var	$path_dir_thumb = 'upload/direction/thumb/';
	var	$path_url = 'otadmin/direction/';
	var	$table = 'tbl_direction';
	var	$template = 'backend/direction/';
